defmodule TemplateTest do
  ...
  @simple_elem "./test/fixtures/html/simple_element.html.tex"
  ...
  @elem_w_attrs "./test/fixtures/html/elem_with_attrs.html.tex"
  ...
  @list_elem "./test/fixtures/html/list_elem.html.tex"
  @list_data texas: %{
  ...
  @dyn_attrs "./test/fixtures/html/dyn_attrs.html.tex"
